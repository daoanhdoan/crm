 ...
 */
class CrmToolbarHandler implements ContainerInjectionInterface, TrustedCallbackInterface {
      ...
      $items['crm'] += [
        ...
        'tray' => [
          ...
          'devel_menu' => [
            ...
            '#lazy_builder' => [CrmToolbarHandler::class . ':lazyBuilder', []],
  ...
  public function lazyBuilder() {
    ...
    $manipulators = [
      ...
      ['callable' => CrmToolbarHandler::class . ':processTree'],
    ];
